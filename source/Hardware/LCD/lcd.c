...
void LCD_Fill(u16 xsta, u16 ysta, u16 xend, u16 yend, u16 color)
{
    ...
    total = (u32)(xend - xsta + 1) * (u32)(yend - ysta + 1);
...
void LCD_ShowChar(u16 x,u16 y,u8 num,u16 fc,u16 bc,u8 sizey,u8 mode)
{
	...
	u16 x0=x;
	sizex=sizey/2;
	if(x + sizex - 1 >= LCD_W || y + sizey - 1 >= LCD_H)
	{
		return;
	}
...
//     while(*p!='\0')
//     {       
//         // 这里需要将 *p (char) 强制转换为 u8，以匹配 LCD_ShowChar 的定义
//         LCD_ShowChar(x,y,(u8)*p,fc,bc,sizey,mode);
//         x+=sizey/2;
//         p++;
//     }  
// }
...
void LCD_ShowIntNum(u16 x, u16 y, int32_t num, u8 len, u16 fc, u16 bc, u8 sizey)
{
    ...
    LCD_ShowString(x, y, buf, fc, bc, sizey, 0);
...
void LCD_ShowPicture(u16 x, u16 y, u16 length, u16 width, const u8 pic[])
{
    ...
    if(x + length - 1 >= LCD_W || y + width - 1 >= LCD_H)
    {
        return;
    }
